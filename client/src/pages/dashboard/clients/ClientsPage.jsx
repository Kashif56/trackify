...
const ClientsPage = () => {
  ...
  const handleViewClient = (client) => {
    // You could navigate to a client detail page or show a modal
    toast.info(`Viewing client: ${client.name}`);
  };
  ...
  if (error) {
    return (
      <div className="p-6 bg-red-50 rounded-lg border border-red-200 text-center">
        ...
        <h2 className="text-xl font-semibold text-red-700 mb-2">Error Loading Clients</h2>
