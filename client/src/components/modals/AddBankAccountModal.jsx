...
const AddBankAccountModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await bankAccountApi.createBankAccount(formData);
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-xs border border-gray-200 shadow-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-md p-6 relative">
        ...
        <h3 className="text-xl font-bold text-gray-800 mb-6">Add Bank Account</h3>
